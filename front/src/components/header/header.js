            ...
            <header className={className}>
                ...
                <nav className="nav-main">
                    <ul className="nav-list">
                        ...
                        {localStorage.getItem('type') == "Producator" && <li><Link className="nav-item" to="/homepage">Loturi de pamant</Link></li>}
                        {localStorage.getItem('type') == "Producator" && <li><Link className="nav-item" to="/addSale">Vrei sa vinzi ceva?</Link></li>}
